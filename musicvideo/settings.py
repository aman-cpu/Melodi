"""
Django settings for musicvideo project.
...
ROOT_URLCONF = 'musicvideo.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['templates','templates/melodi'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.normpath(os.path.join(BASE_DIR, 'staticfiles')))
STATIC_URL = '/static/'
STATICFILES_DIRS=(
